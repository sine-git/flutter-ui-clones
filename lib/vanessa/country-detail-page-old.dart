...
class CountryDetailPageOld extends StatefulWidget {
  const CountryDetailPageOld({super.key});

  @override
  State<CountryDetailPageOld> createState() => _CountryDetailPageOldState();
}

class _CountryDetailPageOldState extends State<CountryDetailPageOld> {
