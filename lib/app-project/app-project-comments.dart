...
class AppProjectCommentsPage extends StatefulWidget {
  const AppProjectCommentsPage({super.key});

  @override
  State<AppProjectCommentsPage> createState() => _AppProjectCommentsPageState();
}
...
class _AppProjectCommentsPageState extends State<AppProjectCommentsPage> {
              ...
              child: TextField(
                decoration: InputDecoration(
                  prefixIcon: Padding(
                    ...
                    child: IconButton(
                      onPressed: () {},
                      icon: Icon(Icons.photo_camera, color: Color(0xFF8B8D97)),
                      style: ButtonStyle(
                  ...
                  hintStyle: TextStyle(fontSize: 14, color: Color(0xFF8B8D97)),
